...
local TelescopeUtil = require("util.lua.telescope")
...
return {
	...
	-- 		{ "<leader>sg", TelescopeUtil.telescope("live_grep"), desc = "grep root dir" },
	-- 		{ "<leader>sf", TelescopeUtil.telescope("files"), desc = "search files" },
