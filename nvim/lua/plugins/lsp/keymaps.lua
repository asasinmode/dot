  ...
  if not M._keys then
    ...
    M._keys = {
      ...
      { '<leader>ca', vim.lsp.buf.code_action,                   desc = '[C]ode [A]ction',                 mode = { 'n',
        'v' },                                                                                                                        has =
      'codeAction' },
      { 'gd',         '<cmd>Telescope lsp_definitions<cr>',      desc = '[G]oto [D]efinition',             has =
      'definition' },
      ...
      { "<leader>cf", format,                                    desc = "[C]ode [F]ormat Document",
                                                                                                             has =
        "documentFormatting" },
      { "<leader>cf", format,                                    desc = "[C]ode [F]ormat Range",           mode = "v",
                                                                                                                                        has =
